...
import cn.hom1.app.oauth.config.AuthSource;
...
import cn.hom1.app.oauth.utils.UrlBuilder;
import cn.hom1.app.utils.UuidUtils;
...
public abstract class AuthDefaultRequest implements AuthRequest {
    ...
    public AuthResponse login(AuthCallback authCallback) {
        try {
            ...
            System.out.println("Failed to login with oauth authorization.");
