        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-xs-6" id="widgetPostCountBody">
            <div class="small-box bg-aqua">
              <div class="inner"><h3><@articleTag method="webSiteCount">${webSiteCount!0}</@articleTag></h3><p>网站</p></div>
              <div class="icon"><i class="ion ion-bag"></i></div>
              <a data-pjax="true" href="/admin/website" class="small-box-footer" data-pjax-state="">查看所有 <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <div class="col-lg-3 col-xs-6" id="widgetCommentCountBody">
            <div class="small-box bg-green">
              <div class="inner"><h3><@articleTag method="webSiteCount">${webSiteCount!0}</@articleTag></h3><p>评论</p></div>
          ...
          <div class="col-lg-3 col-xs-6" id="widgetAttachmentCountBody">
            <div class="small-box bg-yellow">
              <div class="inner"><h3><@articleTag method="webSiteCount">${webSiteCount!0}</@articleTag></h3><p>附件</p></div>
          ...
          <div class="col-lg-3 col-xs-6" id="widgetDayCountBody">
            <div class="small-box bg-red">
              <div class="inner"><h3 id="blogStart"><@articleTag method="webSiteCount">${webSiteCount!0}</@articleTag></h3><p>成立天数</p></div>
