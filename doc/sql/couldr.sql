...
) ENGINE = MyISAM AUTO_INCREMENT = 1469 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `website` VALUES (942, '2020-01-12 22:41:25', 'upload/2020/1/couldr_com_-8c3216fa7e1a459092400bf06eaaadef.png', 0, '一站式搞定PPT设计导航站点', '三顿PPT导航', 'private', 'https://sandunppt.com/', 0);
...
CREATE TABLE `website_category`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1409 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Fixed;
